...
```bibtex
@misc{delaserna2024_obesidad_diabetes_america,
  author    = {de la Serna Tuya, Juan Moisés},
  title     = {Obesidad Diabetes America Latina},
  year      = {2024},
  doi       = {10.5281/zenodo.19145316},
  url       = {https://github.com/juanmoisesd/obesidad-diabetes-america-latina},
  publisher = {Zenodo},
  license   = {CC0-1.0}
}
```

**APA:** de la Serna Tuya, J. M. (2024). *Obesidad Diabetes America Latina*. https://doi.org/10.5281/zenodo.19145316
